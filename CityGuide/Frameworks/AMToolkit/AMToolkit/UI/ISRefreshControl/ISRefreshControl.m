...
- (void) expandActivityIndicator;
- (void) shrinkActivityIndicatorWithCompletion:(void (^)(BOOL))completion;
...
- (void)endRefreshing
{
    ...
    [self.superview bringSubviewToFront:self];
    [self shrinkActivityIndicatorWithCompletion:^(BOOL finished) {
