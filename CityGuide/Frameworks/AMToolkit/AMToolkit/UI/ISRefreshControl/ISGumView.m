...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.imageView.image = [self createArrowImage];
...
- (UIImage *) createArrowImage {
	...
	CGPoint topOrigin = CGPointMake(17.5, 21);
...
//	CGContextSetLineWidth(ctx, 0.5);
	...
	CGContextSetShadowWithColor(ctx, CGSizeMake(0, -0.5), 1, [[UIColor grayColor] CGColor]);
