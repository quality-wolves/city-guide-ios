...
- (NSURLRequest *) requestWithUrl:(NSURL *) url options:(SDWebImageDownloaderOptions)options {
...
- (NSCachedURLResponse *) cachedResponseForUrl:(NSURL *) url options:(SDWebImageDownloaderOptions)options {
    return [[NSURLCache sharedURLCache] cachedResponseForRequest:[self requestWithUrl:url options:options]];
}
...
- (id <SDWebImageOperation>)downloadImageWithURL:(NSURL *)url options:(SDWebImageDownloaderOptions)options progress:(void (^)(NSInteger, NSInteger))progressBlock completed:(void (^)(UIImage *, NSData *, NSError *, BOOL))completedBlock {
    ...
    [self addProgressCallback:progressBlock andCompletedBlock:completedBlock forURL:url createCallback:^{
        NSURLRequest *request = [wself requestWithUrl:url options:options];
